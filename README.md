...
👉 To access the interface, [click here.](https://lucasgallone.github.io/AbracaDABra-TII-Logs-Analyzer/)
<br>
Otherwise, copy and paste the following URL: `https://lucasgallone.github.io/AbracaDABra-TII-Logs-Analyzer/`
...
If you notice any bug (despite the tests I have carried out), do not hesitate to report it in the [Issues](https://github.com/LucasGallone/AbracaDABra-TII-Logs-Analyzer/issues) section.
